...
enum
{
  zed_interfaces__msg__PosTrackStatus__NOT_OK = 1
};
...
enum
{
  zed_interfaces__msg__PosTrackStatus__OFF = 1
};

/// Constant 'CALIBRATION_IN_PROGRESS'.
enum
{
  zed_interfaces__msg__PosTrackStatus__CALIBRATION_IN_PROGRESS = 2
};

// Struct defined in msg/PosTrackStatus in the package zed_interfaces.
typedef struct zed_interfaces__msg__PosTrackStatus
{
  uint8_t visual_odometry_tracking_status;
  uint8_t map_tracking_status;
