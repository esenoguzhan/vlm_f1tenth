  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: visual_odometry_tracking_status
  {
    cdr << ros_message->visual_odometry_tracking_status;
  }

  // Field name: map_tracking_status
  {
    cdr << ros_message->map_tracking_status;
  }

  // Field name: imu_fusion_status
  {
    cdr << ros_message->imu_fusion_status;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name visual_odometry_tracking_status
  {
    size_t item_size = sizeof(ros_message->visual_odometry_tracking_status);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name map_tracking_status
  {
    size_t item_size = sizeof(ros_message->map_tracking_status);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name imu_fusion_status
  {
    size_t item_size = sizeof(ros_message->imu_fusion_status);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name status
  ...
  size_t current_alignment)
{
  ...
  // member: visual_odometry_tracking_status
  {
    size_t array_size = 1;

    current_alignment += array_size * sizeof(uint8_t);
  }
  // member: map_tracking_status
  {
    size_t array_size = 1;

    current_alignment += array_size * sizeof(uint8_t);
  }
  // member: imu_fusion_status
  {
    size_t array_size = 1;
