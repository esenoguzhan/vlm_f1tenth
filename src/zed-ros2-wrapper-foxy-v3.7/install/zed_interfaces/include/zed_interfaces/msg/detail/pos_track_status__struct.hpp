...
struct PosTrackStatus_
{
  ...
  explicit PosTrackStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    ...
    {
      this->visual_odometry_tracking_status = 0;
      this->map_tracking_status = 0;
      this->imu_fusion_status = 0;
      this->status = 0;
    }
  }
  ...
  using _visual_odometry_tracking_status_type =
    uint8_t;
  _visual_odometry_tracking_status_type visual_odometry_tracking_status;
  using _map_tracking_status_type =
    uint8_t;
  _map_tracking_status_type map_tracking_status;
  using _imu_fusion_status_type =
    uint8_t;
  _imu_fusion_status_type imu_fusion_status;
  using _status_type =
    uint8_t;
  _status_type status;

  // setters for named parameter idiom
  Type & set__visual_odometry_tracking_status(
    const uint8_t & _arg)
  {
    this->visual_odometry_tracking_status = _arg;
    return *this;
  }
  Type & set__map_tracking_status(
    const uint8_t & _arg)
  {
    this->map_tracking_status = _arg;
    return *this;
  }
  Type & set__imu_fusion_status(
    const uint8_t & _arg)
  {
    this->imu_fusion_status = _arg;
    return *this;
  }
  Type & set__status(
    const uint8_t & _arg)
  ...
  static constexpr uint8_t OK =
    0u;
  static constexpr uint8_t NOT_OK =
    1u;
  ...
  {
    if (this->visual_odometry_tracking_status != other.visual_odometry_tracking_status) {
      return false;
    }
    if (this->map_tracking_status != other.map_tracking_status) {
      return false;
    }
    if (this->imu_fusion_status != other.imu_fusion_status) {
      return false;
    }
...
template<typename ContainerAllocator>
constexpr uint8_t PosTrackStatus_<ContainerAllocator>::NOT_OK;
template<typename ContainerAllocator>
...
template<typename ContainerAllocator>
constexpr uint8_t PosTrackStatus_<ContainerAllocator>::CALIBRATION_IN_PROGRESS;
