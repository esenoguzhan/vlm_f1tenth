...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("waypoints_path", "/home/f1tenth/lab_ws25/src/stanley_avoidance/racelines/min_curve.csv")
        self.declare_parameter("waypoints_path_2nd", "/home/f1tenth/lab_ws25/src/stanley_avoidance/racelines/min_curve.csv")
        ...
        self.declare_parameter("K_i", 0.3)
        self.declare_parameter("K_d", 0.06)
        ...
        self.declare_parameter("min_lookahead", 0.1)
        ...
        self.declare_parameter("velocity_min", 0.1)
