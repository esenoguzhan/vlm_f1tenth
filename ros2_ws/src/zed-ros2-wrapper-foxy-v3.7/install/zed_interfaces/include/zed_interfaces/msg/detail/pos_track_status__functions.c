...
zed_interfaces__msg__PosTrackStatus__are_equal(const zed_interfaces__msg__PosTrackStatus * lhs, const zed_interfaces__msg__PosTrackStatus * rhs)
{
  ...
  // visual_odometry_tracking_status
  if (lhs->visual_odometry_tracking_status != rhs->visual_odometry_tracking_status) {
    return false;
  }
  // map_tracking_status
  if (lhs->map_tracking_status != rhs->map_tracking_status) {
    return false;
  }
  // imu_fusion_status
  if (lhs->imu_fusion_status != rhs->imu_fusion_status) {
    return false;
  }
  // status
  ...
  zed_interfaces__msg__PosTrackStatus * output)
{
  ...
  // visual_odometry_tracking_status
  output->visual_odometry_tracking_status = input->visual_odometry_tracking_status;
  // map_tracking_status
  output->map_tracking_status = input->map_tracking_status;
  // imu_fusion_status
  output->imu_fusion_status = input->imu_fusion_status;
  // status
