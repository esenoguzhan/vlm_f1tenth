...
class Nano_LLM_Subscriber(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('image_size', 384)      # Larger = more accurate
        ...
        self.query = "You are the brain of a toy car. The car is placed on the ground. What should the car do to avoid any obsactles? Say LEFT, CENTER, RIGHT, or NONE."
